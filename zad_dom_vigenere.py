...
print('Test encrypt_vigenere() 1: ' + test_result)

# Test encrypt_vigenere() 2:
...
test_result = 'OK' if encrypt_vigenere(test_input_text, test_input_key) == test_output_text else 'NOT OK'
print('Test encrypt_vigenere() 2: ' + test_result)

# Test encrypt_vigenere() 3:
test_input_text = 'nic nie powinno sie zmienic'
test_input_key = 'A'
test_output_text = 'nic nie powinno sie zmienic'
test_result = 'OK' if encrypt_vigenere(test_input_text, test_input_key) == test_output_text else 'NOT OK'
print('Test encrypt_vigenere() 3: ' + test_result)

# Test decrypt_vigenere() 1:
...
print('Test decrypt_vigenere() 1: ' + test_result)

# Test decrypt_vigenere() 2:
...
test_result = 'OK' if decrypt_vigenere(test_input_text, test_input_key) == test_output_text else 'NOT OK'
print('Test decrypt_vigenere() 2: ' + test_result)

# Test decrypt_vigenere() 3:
test_input_text = 'powinno wyjsc to samo'
test_input_key = 'AAAA'
test_output_text = 'powinno wyjsc to samo'
test_result = 'OK' if decrypt_vigenere(test_input_text, test_input_key) == test_output_text else 'NOT OK'
print('Test decrypt_vigenere() 3: ' + test_result)
